    ...
    <div className='relative h-[56.25vw]'>
      ...
      <div className='absolute top-[30%] ml-4 md:top-[40%] md:ml-16'>
        ...
        <div className='mt-3 flex items-start gap-3 md:mt-4'>
          ...
          <button className='flex items-center rounded-md bg-white bg-opacity-30 px-2 py-1 text-xs text-white transition hover:bg-opacity-20 md:px-4 md:py-2 lg:text-lg'>
